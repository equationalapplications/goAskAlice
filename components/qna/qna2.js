...
//import { RNFS } from 'react-native-fs';
//const mdelJson = require('../../assets/models/mobilebert_1/model.json');
//const mdelWeightsId  = require('../../assets/models/mobilebert_1/combined.bin');
const vocJson = require('../../assets/models/mobilebert_1/processed_vocab.json');
...
(function (global, factory) {
    ...
    ***************************************************************************** */
    ...
    //  var VOCAB_URL = '../../assets/models/mobilebert_1/processed_vocab.json';
    ...
    var BertTokenizer = (function () {
            ...
            return __awaiter(this, void 0, void 0, function () {
                ...
                return __generator(this, function (_b) {
                    switch (_b.label) {
                        case 0:
                            _a = this;
                            // kv                            return [4, this.loadVocab()]; // orig
                            return [4, vocJson];
                        case 1:
                            _a.vocab = _b.sent();
                            this.trie = new Trie();
        ...
        BertTokenizer.prototype.loadVocab = function () {
            // kv            return __awaiter(this, void 0, void 0, function () {
            // kv                return __generator(this, function (_a) {
            // kv                   return [2, tf.util.fetch(VOCAB_URL).then(function (d) { return d.json(); })]; // orig
            return [2, vocJson];
            // kv                });
            // kv            });
        };
            ...
            return __awaiter(this, void 0, void 0, function () {
                ...
                return __generator(this, function (_c) {
                    switch (_c.label) {
                        case 0:
                            _a = this;
// kv load qna model locally                            
                            const modelPath = '../../assets/models/mobilebert_1/model.json';
                            const weightsPath = '../../assets/models/mobilebert_1/combined.bin';
                            // load modelJson
                            let asset_content = null;
                            try {
                                RNFetchBlob.fs.readFile(modelPath, 'utf8')
                                  .then((data) => {
                                    asset_content = data;
                            ...
                            const modelJson = JSON.parse(asset_content);
                            // load weightsNumber base64                            
                            let asset_content2 = null;
                            try {
                                RNFetchBlob.fs.readFile(weightsPath, 'base64')
                                  .then((data) => {
                                    asset_content = data;
                                    console.log("got data: ", data);
                                  })
                            ...
                            const weightsNumber = JSON.parse(asset_content2);
                            //const modelWeightsID = require(weightsPath);
                            //                            return [4, tfconv.loadGraphModel(this.modelConfig.modelUrl)]; // orig
                            return [4, tfconv.loadGraphModel(bundleResourceIO(modelJson, weightsNumber))];
                ...
                return __generator(this, function (_a) {
                    switch (_a.label) {
                        case 0:
                            ...
                            promises = features.map(function (feature, index) {
